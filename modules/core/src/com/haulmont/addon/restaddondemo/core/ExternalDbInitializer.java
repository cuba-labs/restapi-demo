...
package com.haulmont.addon.restaddondemo.core;
...
public class ExternalDbInitializer implements AppContext.Listener {
    ...
    public void createDbSchema() {
        try {
            ...
            InputStream stream = getClass().getResourceAsStream("/com/haulmont/addon/restaddondemo/core/entity/multidb/create-db.sql");
